...
ADD_PROFILE_PROMPT_NAME = "لطفاً یک نام برای پروفایل جدید وارد کنید (مثال: پروفایل گیمینگ آلمان):"
ADD_PROFILE_PROMPT_PRICE = "قیمت پروفایل را به تومان وارد کنید (مثال: 250000):"
ADD_PROFILE_PROMPT_VOLUME = "مجموع حجم ترافیک پروفایل را به گیگابایت (GB) وارد کنید (مثال: 100):"
ADD_PROFILE_PROMPT_DURATION = "مدت زمان اعتبار پروفایل را به روز وارد کنید (مثال: 30):"
